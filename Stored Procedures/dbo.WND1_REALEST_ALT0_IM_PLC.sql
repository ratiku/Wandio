...
SET ANSI_NULLS ON
GO
CREATE PROCEDURE [dbo].[WND1_REALEST_ALT0_IM_PLC]
    @p_donor_id BIGINT,
...
BEGIN
    DECLARE @etl_log_key BIGINT,
            @package_name NVARCHAR(40) = N'WND1_REALEST_ALT0_IM_PLC',
    ...
    BEGIN TRY
        ...
        (
            SELECT CASE
                   ...
                   ISNULL(a.REG_NUMBER, 'XNA') REG_NUMBER,
                   ISNULL(a.REAL_EST_TP_DESCR, 'XNA') REAL_EST_TP_DESCR,
                   ISNULL(a.OWN_TP_DESCR, 'XNA') OWN_TP_DESCR,
                   ISNULL(a.REAL_EST_SUB_TP_DESCR, 'XNA') REAL_EST_SUB_TP_DESCR,
                   a.ENTRANCE_NUMBER,
                   a.FLOOR_NUMBER,
                   a.FLAT_NUMBER,
                   a.FLAT_AREA,
        ...
        WHEN MATCHED THEN
            UPDATE SET TRG.ITEM_KEY = SRC.ITEM_KEY,
                       ...
                       TRG.ADDR = SRC.ADDR,
                       TRG.REG_NUMBER = SRC.REG_NUMBER,
                       TRG.REAL_EST_TP_DESCR = SRC.REAL_EST_TP_DESCR,
                       TRG.OWN_TP_DESCR = SRC.OWN_TP_DESCR,
                       TRG.REAL_EST_SUB_TP_DESCR = SRC.REAL_EST_SUB_TP_DESCR,
                       TRG.ENTRANCE_NUMBER = SRC.ENTRANCE_NUMBER,
                       TRG.FLOOR_NUMBER = SRC.FLOOR_NUMBER,
                       TRG.FLAT_NUMBER = SRC.FLAT_NUMBER,
                       TRG.FLAT_AREA = SRC.FLAT_AREA,
                       TRG.PART_NUMERATOR = SRC.PART_NUMERATOR,
                       TRG.PART_DENOMINATOR = SRC.PART_DENOMINATOR,
                       TRG.DESCR = SRC.DESCR,
                       TRG.MEASURED_AREA = SRC.MEASURED_AREA,
                       TRG.DOCUMENTED_AREA = SRC.DOCUMENTED_AREA,
                       TRG.DEL_FLAG = 0,
        ...
        WHEN NOT MATCHED THEN
            ...
            VALUES
            (SRC.ITEM_KEY, SRC.REAL_EST_TP_KEY, SRC.TP_ID, SRC.CADASTRAL_NUMBER, SRC.ADDR, SRC.REG_NUMBER,
             SRC.REAL_EST_TP_DESCR, SRC.OWN_TP_DESCR, SRC.REAL_EST_SUB_TP_DESCR, SRC.ENTRANCE_NUMBER, SRC.FLOOR_NUMBER,
             SRC.FLAT_NUMBER, SRC.FLAT_AREA, SRC.PART_NUMERATOR, SRC.PART_DENOMINATOR, SRC.DESCR, SRC.MEASURED_AREA,
             SRC.DOCUMENTED_AREA, SRC.SRC_ID, SRC.SRC_SYS_ID, 0,
